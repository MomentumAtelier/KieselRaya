...
export default function ContactsPage() {
  ...
  const fields: FieldConfig[] = [
    ...
    { name: "assistant_name", label: "Assistant's name", type: "text" },
    ...
    { name: "interests", label: "Interests / hobbies", type: "text", colSpan: 2 },
    { name: "family_notes", label: "Family notes", type: "textarea", colSpan: 2 },
    { name: "personal_notes", label: "Personal notes", type: "textarea", colSpan: 2 },
    { name: "notes", label: "General notes", type: "textarea", colSpan: 2 },
  ];
    ...
    <div>
      ...
      {modalOpen && (
        <RecordModal
          ...
          fields={fields}
          initialValues={
            editing ? { ...editing, birthday: toDateInputValue(editing.birthday) } : {}
          }
          onClose={() => {
            setModalOpen(false);
            setEditing(null);
